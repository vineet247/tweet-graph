...
class TestProcessTweets(unittest.TestCase):
        ...
        self.tweets = [
            {
                ...
                "entities": {"hashtags": [{"text": "bored"}]},
            },
            {
                "text": "Not much to do in the winters!! #bored #cold",
                "entities": {"hashtags": [{"text": "bored"}, {"text": "cold"}]},
            },
            {
                "text": "Summers in Chennai are super hooooot #heat #hot",
                "entities": {"hashtags": [{"text": "heat"}, {"text": "hot"}]},
            },
        ]
    ...
    def test_insert_to_graph(self):
        ...
        expected_result = {'bored': {'tweets': ['Some tweet regarding something #bored', 'Not much to do in the winters!! #bored #cold'], 'hashtags': {'cold': 1}}, 'cold': {'tweets': ['Not much to do in the winters!! #bored #cold'], 'hashtags': {'bored': 1}}, 'heat': {'tweets': ['Summers in Chennai are super hooooot #heat #hot'], 'hashtags': {'hot': 1}}, 'hot': {'tweets': ['Summers in Chennai are super hooooot #heat #hot'], 'hashtags': {'heat': 1}}}
    ...
    def test_delete_from_graph(self):
        ...
        expected_result = expected_result = {
            "bored": {
                "hashtags": {"cold": 1},
                "tweets": [
                    "Some tweet regarding something #bored",
                    "Not much to do in the winters!! #bored #cold",
                ],
            },
            "cold": {
                "hashtags": {"bored": 1},
                "tweets": ["Not much to do in the winters!! #bored #cold"],
            },
        }
        self.assertEqual(expected_result, process_tweets.tweet_graph)
    ...
    def test_delete_from_graph_exception(self):
        ...
        with self.assertRaises(Exception) as assert_exception:
            process_tweets.delete_from_graph(
                json.dumps(self.tweet_to_be_deleted_exception)
            )

        self.assertEqual(
            assert_exception.exception.args[0],
            "Tag not in tweet graph. Cannot be deleted",
        )
